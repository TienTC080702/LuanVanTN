    ...
    <table cellpadding="0" cellspacing="0">
        <tr class="top">
            <td colspan="4"> <table>
                    <tr>
                        <td class="title">
                            <img src="../images/logo.png" style="width:100%; max-width:150px;" alt="Logo Cửa hàng"> </td>
                        <td class="text-right">
                ...
                <table>
                    <tr>
                        <td class="company-details">
                            <strong>CỬA HÀNG MỸ PHẨM ABC</strong><br> <?php // Thay thông tin cửa hàng ?>
                            123 Đường XYZ, Quận Ninh Kiều<br>
                            Cần Thơ, Việt Nam<br>
